...
struct DataClass: Decodable {
    let id, sku, name, attributeSetID: String?
    let price, finalPrice, status, type: String?
    let brand: String?
    let image: String?
    let createdAt, updatedAt, weight: String?
    let isSalable: Bool?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case images, upsell, related
    }
}

// MARK: - ConfigurableOption
struct ConfigurableOption: Decodable {
    let attributeID: Int?
    let attributeLabel, type, attributeCode: String?
...
struct Attribute: Decodable {
    let value, optionID, attributeImageURL, hexCode: String?
    let price: String?
    let images: [String]?
